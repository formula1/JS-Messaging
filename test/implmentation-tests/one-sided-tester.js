...
var MessengerToClient = require('../../../../node/server2client/Client');
...
module.exports = function(at){
  ...
  at.test('Can do requests', function(t){
    var messengers;
    return createMessengers(t).then(t, function(objs){
      messengers = objs;
      return Tester.canDoRequests(t, messengers[0], messengers[1]);
    }).then(function(){
      return Tester.canDoRequests(t, messengers[1], messengers[0]);
    }).then(function(){
      return cleanupMessengers(t, messengers);
    }).catch(t.threw.bind(t)).then(function(){
      t.end();
    });
  });
  ...
  at.test('Can do streams', function(t){
    ...
    return createMessengers(t).then(function(objs){
      messengers = objs;
      return Tester.canDoStreams(t, messengers[0], messengers[1]);
    }).then(function(){
      return Tester.canDoStreams(t, messengers[1], messengers[0]);
    }).catch(t.threw.bind(t)).then(function(){
      return cleanupMessengers(t, messengers);
    });
  });
