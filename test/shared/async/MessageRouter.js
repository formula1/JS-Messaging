...
module.exports = function(at, generateRouter, expectedValues){
  at.test('Can route events', function(t){
    generateRouter().then(function(router){
      router.onEvent(/a\/path/, function(message, responder){
        t.equal(message, expectedValues[0], 'Recieved the correct value');
